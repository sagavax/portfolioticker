...
<body>
  ...
  <div class="modal-container">
   <h3>Add a new analysis</h3>
    <div id="modaNerwAnalysiskContent">
    ...
    <div class="modal-actions">
      <button id="modalNewAnalysiskSave" type="button" ckass="secondary">Uložiť</button>
      <button id="modalNewAnalysiskClose" class="secondary">Zatvoriť</button>
    </div>
  </div>
</div>
</body>
